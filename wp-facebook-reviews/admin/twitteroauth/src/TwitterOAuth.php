...
class TwitterOAuth extends Config
{
    ...
    {
        // Use the CA bundle shipped with the plugin instead of composer/ca-bundle
        // so the library works without Composer being installed.
        $bundlePath = __DIR__ . DIRECTORY_SEPARATOR . 'cacert.pem';
        $options = [
